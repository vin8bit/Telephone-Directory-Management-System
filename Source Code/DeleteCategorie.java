...
public class DeleteCategorie implements ActionListener 
{
	...
	public DeleteCategorie(Main m)
	{
		jd=new JDialog(m);
		jd.setSize(500,480);
		jd.setIconImage(new ImageIcon("image/logo.png").getImage());
		jd.setTitle("Delete Categorie");
		JPanel p1=new JPanel();
		p1.setBounds(0,0,500,500);	
		p1.setLayout(null);
		jd.add(p1);
		JLabel tl=new JLabel("Delete Categorie");
				...
				{ if(s1.isEmpty()||s2.isEmpty()||s3.isEmpty()||s4.isEmpty()||s5.isEmpty()||s6.isEmpty())
					...
					for(int y2=0;y2<i2.length(); ++y2)
					{
						...
						ltf6.setText("");
							...
							else { JOptionPane.showMessageDialog(jd,"ID or Contact  only Number accepted","Error",JOptionPane.ERROR_MESSAGE); } 						
