...
public class DeleteCustomer implements ActionListener ,ItemListener
{
	...
	public DeleteCustomer(Main m)
	{
		jd = new JDialog(m);
		jd.setIconImage(new ImageIcon("image/logo.png").getImage());
		jd.setSize(500,500);
		jd.setTitle("Delete Customer");
		JPanel p1=new JPanel();
		p1.setBounds(0,0,500,500);	
		p1.setLayout(null);
		jd.add(p1);
		JLabel tl=new JLabel("Delete Customer");
